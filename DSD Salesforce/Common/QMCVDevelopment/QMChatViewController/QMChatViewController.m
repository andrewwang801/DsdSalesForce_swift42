...
<QMInputToolbarDelegate, QBImagePickerControllerDelegate,
...
@property (strong, nonatomic, readonly) QBImagePickerController *pickerController;
...
- (QBImagePickerController *)pickerController
{
    if (_pickerController == nil) {
        _pickerController = [QBImagePickerController new];
...
- (void)didPressAccessoryButton:(UIButton *)sender {
    ...
    self.pickerController.mediaType = QBImagePickerMediaTypeImage;
    self.pickerController.prompt = @"Select the image/video";
...
- (void)didPickAttachmentVideo:(NSURL *)videoURL {
    NSAssert(NO, @"Error! required method not implemented in subclass. Need to implement %s", __PRETTY_FUNCTION__);
}
...
- (void)qb_imagePickerController:(QBImagePickerController *)imagePickerController didFinishPickingAssets:(NSArray *)assets {
    ...
    if (asset.mediaType == PHAssetMediaTypeImage) {
        ...
        [manager requestImageForAsset:asset targetSize:targetSize contentMode:PHImageContentModeDefault options:requestOptions resultHandler:^(UIImage * _Nullable result, NSDictionary * _Nullable info) {
            if (result != nil) {
                [self didPickAttachmentImage:result];
            }
        }];
    }
    else {
        ...
        [manager requestAVAssetForVideo:asset options:nil resultHandler:^(AVAsset * _Nullable asset, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
            ...
            [self didPickAttachmentVideo:videoURL];
        }];
    }
}
