...
public typealias IndexInt = Int
public typealias Closure = () -> Void
public typealias SelectionClosure = (IndexInt, String) -> Void
public typealias MultiSelectionClosure = ([IndexInt], [String]) -> Void
public typealias ConfigurationClosure = (IndexInt, String) -> String
public typealias CellConfigurationClosure = (IndexInt, String, DropDownCell) -> Void
...
public final class DropDown: UIView {
	...
	*/
	...
	fileprivate var selectedRowIndices = Set<IndexInt>()
...
extension DropDown {
	...
	*/
	...
	public func selectRow(at index: IndexInt?) {
		if let index = index {
            tableView.selectRow(
    ...
    public func selectRows(at indices: Set<IndexInt>?) {
        indices?.forEach {
            selectRow(at: $0)
        }
	...
	public func deselectRow(at index: IndexInt?) {
    ...
    public func deselectRows(at indices: Set<IndexInt>?) {
        indices?.forEach {
            deselectRow(at: $0)
        }
    }
	...
	public var indexForSelectedRow: IndexInt? {
    ...
    @objc public func selectRow(_ index: Int) {
        self.selectRow(at:IndexInt(index))
    }
    ...
    @objc public func deselectRow(_ index: Int) {
        tableView.deselectRow(at: IndexPath(row: IndexInt(index), section: 0), animated: true)
    }
