...
class PaymentCollectionCell: UITableViewCell {
    ...
    var parentVC: PaymentCollectionVC!
    var indexPath: IndexPath!

    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        checkBoxButton.addTarget(self, action: #selector(PaymentCollectionCell.onTapCheckBox(_:)), for: .touchUpInside)
    }
    ...
    func setupCell(parentVC: PaymentCollectionVC, indexPath: IndexPath) {
