...
class GroupsVC: UIViewController, QMAuthServiceDelegate {
...
extension GroupsVC: UIScrollViewDelegate {
...
extension GroupsVC: QMChatServiceDelegate {
...
extension GroupsVC: QMChatConnectionDelegate {
...
extension GroupsVC: IndicatorInfoProvider {
